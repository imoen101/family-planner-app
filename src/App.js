...
export default function App() {
  ...
  function updateSlot(key, patch) {
    ...
    const isChangingState =
      typeof patch.state !== 'undefined' && patch.state !== current.state;
    const isChangingType =
      typeof patch.slotType !== 'undefined' &&
      patch.slotType !== current.slotType;
        ...
        >
          <div style={{ ...miniCardStyle(), padding: 20 }}>
            ...
            <div style={{ marginBottom: 16, color: '#475569', fontSize: 14 }}>
              Save a baseline once your planned week is set. Credits are then
              calculated from later changes to swappable slots.
            </div>
              ...
              <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
                <span
                  style={{
                    ...
                    backgroundImage:
                      'repeating-linear-gradient(135deg, #cbd5e1 0px, #cbd5e1 6px, rgba(255,255,255,0.65) 6px, rgba(255,255,255,0.65) 12px)',
                    display: 'inline-block',
                  }}
                ></span>
                Swappable
                ...
                {TIMES.map((time) => (
                  <div
                    ...
                    style={{
                      display: 'grid',
                      gridTemplateColumns:
                        '120px repeat(7, minmax(100px, 1fr))',
                      borderBottom: '1px solid #e2e8f0',
                    }}
                  >
                    <div
                    ...
                    {DAYS.map((day) => {
                      ...
                      const backgroundStyles = getSlotBackground(
                        slot.state,
                        slot.slotType
                      );
                      ...
                      return (
                        <button
                          ...
                          onDoubleClick={() =>
                            updateSlot(key, { state: nextState(slot.state) })
                          }
                          onContextMenu={(e) => {
                            e.preventDefault();
                            setData((prev) => ({ ...prev, selectedKey: key }));
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            <div style={{ ...miniCardStyle(), padding: 20 }}>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    updateSlot(data.selectedKey, { note: e.target.value })
                  }
            ...
            <div style={{ ...miniCardStyle(), padding: 20 }}>
              ...
              <div style={{ display: 'grid', gap: 12 }}>
                <div style={{ ...miniCardStyle(), padding: 14 }}>
                  ...
                  >
                    <div>
                      ...
                      <div style={{ fontSize: 13, color: '#64748b' }}>
                        Extra swappable duty since baseline
                      </div>
                    </div>
                    <div
                      style={{
                ...
                >
                  {data.baselineSlots
                    ? `${creditSummary.changedSlots} slot${
                        creditSummary.changedSlots === 1 ? '' : 's'
            ...
            <div style={{ ...miniCardStyle(), padding: 20 }}>
              ...
              >
                ...
                <div>
                  Double-click a slot to quickly cycle through the states.
                </div>
                <div>Striped slots are swappable. Solid slots are fixed.</div>
                <div>
                  Use ���Set baseline��� once your planned week is in place.
                </div>
                <div>
                  Free shifts are calculated automatically from changes to
                  swappable slots.
                </div>
